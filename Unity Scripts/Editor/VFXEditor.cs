...
{
	static private VFXEditor SingleWindow;
	
	[MenuItem(CommonDefine.ProjectName + "/Custom Editor/VFX Editor")]
	static void ShowWindow()
	{
		VFXEditor window = EditorWindow.GetWindow<VFXEditor>(EditorPrefs.GetBool("CFX_ShowAsToolbox", true), "Easy Editor", true);
